...
export default function About(props) {
  ...
  return (
    ...
    <div id="about" className="container my-5">
        <h2 className={`text-${props.mode === "dark" ? "white" : "dark"} accordion-item`}>About us </h2>

        <div className="accordion" id="accordionExample" style={{
              backgroundColor: props.mode === "dark" ? "lightgray" : "white",
            }}>
  <div  className={`text-${props.mode === "dark" ? "dark" : "dark"} accordion-item`}
            style={{
              backgroundColor: props.mode === "dark" ? "lightgray" : "white",
            }}>
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample" style={{
      ...
      <div className="accordion-body" style={{
              backgroundColor: props.mode === "dark" ? "light" : "white",
            }}>
